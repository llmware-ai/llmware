...
scp ./examples/Models/using_onnx_models.py .
scp ./examples/Models/using_openvino_models.py .
...
echo "    -- using_onnx_models.py"
echo "    -- using_openvino_models.py"
