...
""" Function Calling with SLIMs - this example illustrates how to move beyond basic question-answer prompting,
and begin to integrate function calls into LLM-based workflows.
