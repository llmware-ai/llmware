...
""" This example is a fast start to show the power of leveraging PyWebio for rapid easy-to-integrate UIs ...

    The text below is a standard example that runs a set of inferences and prints output to the console.

    By adding two lines at the top of the script, we now have a simple web UI.

    To run this example:

    `pip3 install pywebio`

    Check out pywebio docs for lots more examples of easily integrating more customized graphical elements.

    https://pywebio.readthedocs.io/en/latest/

    Look for more examples coming soon + welcome creative ideas and contributions from the community!
...
# one line change - assigns standard python 'print' to 'put_text'
...
if __name__ == "__main__":
    ...
    llmware_bling_dragon_hello_world("bling-answer-tool")
