...
Welcome! We appreciate your interest in contributing to the **thesis** project. Follow the steps below to make your contribution:
...
2. **Clone Your Fork**:
   ...
   ```bash
   git clone https://github.com/SusheelThapa/Quine-thesis.git
   ```
